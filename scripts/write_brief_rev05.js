...
const locations = [
  'C:\\Users\\marcus\\Desktop\\mBowl\\mBowl-SessionBrief-REV05.md',
  'C:\\Users\\marcus\\Desktop\\mBowl-SessionBrief-REV05.md',
];

for (const loc of locations) {
  fs.writeFileSync(loc, content, 'utf8');
  console.log('Written:', loc);
}
